...
const TAPP = {
  en:{
    ...
    reviewCardH:"Share your experience", reviewCardL:"If LICENA helped you prepare, leave a review. Approved reviews may appear on our homepage.",
  ...
  es:{
    ...
    reviewCardH:"Comparte tu experiencia", reviewCardL:"Si LICENA te ayudó a prepararte, deja una reseña. Las reseñas aprobadas pueden aparecer en nuestra página principal.",
  ...
  ru:{
    ...
    reviewCardH:"Поделись впечатлением", reviewCardL:"Если LICENA помогла тебе подготовиться — оставь отзыв. Одобренные отзывы могут появиться на нашей главной странице.",
