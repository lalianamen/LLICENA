    ...
    subs: [
      {
        ...
        courses: [
          { id:"cslb-law",  name:{ en:"Law & Business Exam",      es:"Examen Ley y Negocios",    ru:"Экзамен Law & Business",        vi:"Thi Luật & Kinh Doanh"      }, langs:["en","es","ru","vi"], type:"exam"  },
          { id:"asbestos",  name:{ en:"Asbestos Open-Book Exam",  es:"Examen de Asbesto",        ru:"Экзамен по асбесту",            vi:"Thi Amiăng"                 }, langs:["en","es","ru","vi"], type:"exam"  }
        ]
      },
      {
        id: "c20",
        ...
        courses: [
          { id:"c20-exam",  name:{ en:"C-20 Trade Exam",          es:"Examen Trade C-20",        ru:"Trade-экзамен C-20",            vi:"Thi Trade C-20"             }, langs:["en","es","ru","vi"], type:"exam"  },
